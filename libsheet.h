...
public:
	...
	vector<int> get_ivec(const int&); // TODO
	vector<double> get_dvec(const int&); // TODO
	vector<string> get_svec(const int&); // TODO
	vector<int> get_ivec(const string&); // TODO
	vector<double> get_dvec(const string&); // TODO
	vector<string> get_svec(const string&); // TODO
	...
	int col_idx(const string& col) {
		...
		if (got == column_map.end()) throw "No such column";
		return got->second;
	}
